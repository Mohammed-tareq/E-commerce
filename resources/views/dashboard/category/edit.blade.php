...
@section('title')
    {{ __('dashboard.categories') }} | {{ __('dashboard.edit_category') }}
@endsection
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">{{ __('dashboard.edit_category') }}</h3>
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('dashboard.edit_category') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{ __('dashboard.edit_category') }}</h4>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="parent" id="projectinput1"
                                                                ...
                                                                @foreach ($categories as $cat)
                                                                    <option @selected($cat->id == $category->parent) value="{{ $cat->id }}">{{ $cat->getTranslation('name', app()->getLocale()) }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" id="projectinput1"
                                                                    class="form-control">
                                                                <option @selected($category->status === 'Active') value="1">{{ __('dashboard.Active') }}</option>
                                                                <option @selected($category->status === 'Inactive') value="0">{{ __('dashboard.Inactive') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
