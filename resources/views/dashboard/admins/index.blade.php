                ...
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">{{ __('dashboard.admins') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('dashboard.admins') }}</h4>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownBreadcrumbButton">
                                                <a class="dropdown-item"
                                                   href="{{ route('dashboard.admins.edit', $admin->id) }}"><i
                                                            class="la la-edit"></i> {{ __('dashboard.edit_admin') }}</a>
                                                <a class="dropdown-item"
                                                   href="{{ route('dashboard.admins.status', $admin->id) }}"><i
                                                            class="la la-unlock"></i> {{ __('dashboard.change_status') }}</a>
                                                <a class="dropdown-item delete-btn" href="javascript:void(0)"
                                                   data-id="{{ $admin->id }}"><i
                                                            class="la la-trash"></i> {{ __('dashboard.delete') }}</a>

                                                <form id="delete_{{ $admin->id }}"
