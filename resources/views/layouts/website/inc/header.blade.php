        ...
        <div class="container">
            <div class="header-top">
                <div class="header-profile">
                    @auth
                        <a href="{{ route('website.user-profile') }}"><span>{{ auth('web')->user()->first_name . " " . auth('web')->user()->last_name }}</span></a>
                    @endauth
                    <a href="order.html"><span>Track Order</span></a>
                    <a href="{{ route('website.faq.index') }}"><span>{{ __('website.support') }}</span></a>
                </div>
                            ...
                            <div class="modal-main">
                                ...
                                <div class="wrapper-main">
                                    <div class="search-section">
                                        ...
                                        <button type="button">{{ __('website.all_category') }}</button>
                ...
                <div class="category-menu-section position-relative">
                    ...
                    <div class="category-dropdown position-absolute" id="subMenu">
                        <ul class="category-list">
                            ...
                            @forelse($categories as $categoryMobile)
                                <li class="category-list-item">
                                    <a href="{{ route('website.category.products',$categoryMobile->slug) }}">
                                        <div class="dropdown-item">
                                            <div class="dropdown-list-item">
                                                <span class="dropdown-img">
                                                <img src="{{ asset($categoryMobile->image) }}"
                                                     alt="{{ $categoryMobile->name }}">
                                                </span>
                                                <span class="dropdown-text">
                                                {{ $categoryMobile->name }}
                                                </span>
                                ...
                                @if($categoryChildren->count() > 0)
                                    <div class="menu-wrapper">
                                        @foreach($categoryChildren as $categoryChild)
                                            <div class="menu-list">
                                                <h5 class="menu-title">{{ $categoryChild->name }}</h5>
                                                <ul>
                                                    @foreach($categoryChild->children as $child)
                                                        <li>
                                                            <a href="{{route('website.category.products',$child->slug)}}">{{ $child->name }}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </div>
                        ...
                        @auth
                            <li>
                                <a href="{{ route('website.user-profile') }}">
                                    <span class="list-text">{{ __('website.user_profile') }}</span>
                                </a>
                            </li>
                        @endauth
                        <li>
                            <a href="{{ route('website.faq.index') }}">
                                <span class="list-text">{{ __('website.contact') }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
