                    ...
                    <div class="col-md-6">
                        <div class="product-info-content" data-aos="fade-left">
                            ...
                            <div class="product-availability">
                                ...
                                <span class="inner-text">{{ $product->quantity }} {{ __('website.products_available') }}</span>
                            </div>
                            <div class="product-size">
                                <P class="size-title">{{ __('website.size') }}</P>
                                <div class="size-section">
                                    <span class="size-text">{{ __('website.select_your_size') }}</span>
                                ...
                                <ul class="size-option">
                                    <li class="option">
                                        <span class="option-text">{{ __('website.small') }}</span>
                                        <span class="option-measure">3”W x 3”D x 5”H</span>
                                    </li>
                                    <li class="option">
                                        <span class="option-text">{{ __('website.medium') }}</span>
                                        <span class="option-measure">3”W x 3”D x 6”H</span>
                                    </li>
                                    <li class="option">
                                        <span class="option-text">{{ __('website.large') }}</span>
                                        <span class="option-measure">6”W x 3”D x 7”H</span>
                                    </li>
                                    <li class="option">
                                        <span class="option-text">{{ __('website.extra_large') }}</span>
                                        <span class="option-measure">8”W x 4”D x 8”H</span>
                                    </li>
                                    <li class="option">
                                        <span class="option-text">{{ __('website.size_2xl') }}</span>
