            ...
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="replayContact" class="form">
                        ...
                        <div class="form-group">
                            <label for="replayMessage"><i
                                        class="fas fa-comment-dots"></i> {{ __('dashboard.replay_message') }}</label>
                            <textarea rows="4" wire:model="replayMessage" id="replayMessage"
...
<script>
        ...
        Livewire.on('launch-replay-contact-model', () => {
