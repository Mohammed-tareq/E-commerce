        ...
        <div class="tab-pane fade show active">
            <div class="user-profile">
                <div class="user-title">
                    <p class="paragraph"> {{ __('website.hello') }} {{ $user->first_name }} {{ $user->last_name }}</p>
                    <h5 class="heading">{{ __('website.welcome_to_your_profile') }} </h5>
                </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper">
                                ...
                                <div class="wrapper-content">
                                    <p class="paragraph">{{ __('website.order_completed') }}</p>
                                    <h3 class="heading">{{ $orderPaidCount }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper">
                                ...
                                <div class="wrapper-content">
                                    <p class="paragraph">{{ __('website.order_delivered') }}</p>
                                    <h3 class="heading">{{ $orderDeliveredCount }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-wrapper">
                                <div class="wrapper-img">
                                    ...
                                    <path d="M38.0695 46.3142C33.0415 46.3142 28.0847 46.3142 23.0389 46.3142C23.0389 45.9763 23.0342 45.6491 23.0401 45.3219C23.0626 44.0391 22.9796 42.7421 23.1361 41.4747C23.5357 38.2571 26.1261 35.9239 29.3722 35.8208C30.5886 35.7817 31.8417 35.7757 33.0249 36.0164C35.8643 36.595 37.8916 39.0254 38.0552 41.9359C38.1359 43.3704 38.0695 44.8133 38.0695 46.3142Z"
                                          fill="#FFBB38"/>
                                    <path d="M30.5375 33.9233C28.2244 33.9091 26.3501 32.011 26.3832 29.7193C26.4176 27.4122 28.3169 25.5568 30.6157 25.584C32.8849 25.6101 34.7486 27.5011 34.7403 29.7691C34.7332 32.075 32.8481 33.9375 30.5375 33.9233Z"
                                          fill="#FFBB38"/>
                                    </svg>
                                    </span>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="info-section">
                                <div class="seller-info">
                                    <h5 class="heading">{{ __('website.personal_information') }}</h5>
                                    <div class="info-list">
                                        <div class="info-title">
                                            <p>{{ __('website.first_name') }}:</p>
                                            <p>{{ __('website.last_name') }}:</p>
                                            <p>{{ __('website.email') }}:</p>
                                            <p>{{ __('website.phone') }}:</p>
                                        </div>
                                ...
                                <div class="shop-info">
                                    <h5 class="heading">{{ __('website.address_info') }}</h5>
                                    <div class="info-list">
                                        <div class="info-title">
                                            <p>{{ __('website.country') }}:</p>
                                            <p>{{ __('website.governorate') }}:</p>
                                            <p>{{ __('website.city') }}:</p>

                                        </div>
                                        <div class="info-details">
                                            <p>{{ $user->country->getTranslation('name',app()->getlocale()) }}</p>
                                            <p>
                                                {{ $user->governorate->getTranslation('name',app()->getlocale()) }}
                                            </p>
                                            <p>{{ $user->city->getTranslation('name',app()->getlocale()) }}</p>
